...
public class T1 {
    ...
    public static void main(String[] args) {
        ...
        LinkedHashMap<Integer, Object> probabilities = (LinkedHashMap<Integer, Object>) jsonContent.get("probabilities");
        ...
        for (Map.Entry<Integer, Object> entry : probabilities.entrySet()) {
            HashMap<Integer, Double> probabilidadesDaFila = new HashMap<>();

            int queueName = entry.getKey();
            Map<Integer, Object> probData = (Map<Integer, Object>) entry.getValue();

            for (Map.Entry<Integer, Object> probEntry : probData.entrySet()) {
                int proxLugar = probEntry.getKey();
